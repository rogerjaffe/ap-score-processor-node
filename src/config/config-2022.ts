...
export const translatorMaps = {
  ...
  raceEthnicity: {
    ...
    "8": "Black or African American (Including Africa and Afro-Caribbean Origin)",
...
export const config2022: TConfig = {
  awardData: {
    position: 26,
    count: 6,
    fields: [
  ...
  ethnicityData: {
    ...
    ifBlank: "",
    // translate: resultByStringPosition("raceEthnicity"),
  },
  fields: [
    ...
    { position: 10, fieldName: "Province", ifBlank: "" },
    { position: 11, fieldName: "Intl postal code", ifBlank: "" },
